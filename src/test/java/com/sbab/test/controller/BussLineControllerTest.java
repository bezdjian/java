package com.sbab.test.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.sbab.test.BaseTest;
import com.sbab.test.exception.CustomResponseErrorHandler;
import com.sbab.test.exception.ErrorDetails;
import com.sbab.test.service.TrafikService;
...
public class BussLineControllerTest extends BaseTest {
    ...
    public void getStopNames() throws Exception {
        ...
        //When & Expect
        MockHttpServletResponse response = mockMvc.perform(get("/getStops/1"))
                //.andDo(print())
    ...
    public void getMostStops() throws Exception {
        ...
        //When & Expect
        MockHttpServletResponse response = mockMvc.perform(get("/getMostStops"))
                //.andDo(print())
    ...
    public void testCustomError() throws Exception {
        ...
        //when(service.findLineWithMostStops()).thenReturn(createMap());
        //When & Expect
        MockHttpServletResponse response = mockMvc.perform(get("/getStops/oopie"))
                //.andDo(print())
